...
const MESSAGES = {
  en: {
    ...
    settings: {
      ...
      telegramHint: 'Send this command to your Telegram bot to link this account.',
      telegramBotMissing: 'Bot token is not configured. You can save settings, but messages will not be sent.',
      telegramStatus: 'Status',
      telegramLinked: 'Linked',
      telegramNotLinked: 'Not linked',
      telegramRegenerate: 'Regenerate code',
      telegramOpenBot: 'Open bot',
      telegramEnable: 'Enable Telegram notifications',
      telegramTimezone: 'Timezone',
  ...
  ru: {
    ...
    settings: {
      ...
      telegramHint: 'Отправьте эту команду своему Telegram-боту, чтобы привязать аккаунт.',
      telegramBotMissing: 'Токен бота не настроен. Настройки можно сохранить, но сообщения не будут отправляться.',
      telegramStatus: 'Статус',
      telegramLinked: 'Привязан',
      telegramNotLinked: 'Не привязан',
      telegramRegenerate: 'Обновить код',
      telegramOpenBot: 'Открыть бота',
      telegramEnable: 'Включить Telegram-уведомления',
      telegramTimezone: 'Таймзона',
